  ...
  <link type="text/css" rel="stylesheet" href="css/materialize.min.css"  media="screen,projection"/>
	...
	<body>
		<div class="container">
			...
			<h5 style="font-family: arial;">Ubah Data Minuman</h5>
		...
		<form action="" method="post" enctype="multipart/form-data">
			...
			<li>
				...
				<input type="file" name="gambar_produk" id="gambar_produk" class="image" required>
				<img src="">
				<hr>
			</li>
			<li>
				<label for="deskripsi_produk">Deskripsi Minuman :</label>
				<input type="text" name="deskripsi_produk" id="deskripsi_pro	duk" value="<?= $produk["deskripsi_produk"]; ?>" requred>
			</li>
			<li>
			...
			<button name="submit" type="submit" class="waves-effect waves-light btn">Edit Data Minuman</button>
		</ul>
	</form>
</div>
</div>
